...
public class NotificationService {
    ...
    public void notifyUser(User user, NotificationMessage message) {
        NotificationMessage.MessageType messageType = message.getType();
    ...
    private boolean isUserSubscribed(User user, NotificationChannel channel, NotificationMessage.MessageType messageType) {
