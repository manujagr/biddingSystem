...
//
//import com.hrrev.biddingSystem.controller.ProductController;
...
//            assertEquals(mockProductResponse, responseEntity.getBody());
//
...
//        assertEquals("Product registration request cannot be null", responseEntity.getBody());
//
